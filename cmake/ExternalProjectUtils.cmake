...
function(FIND_PACKAGE_EXTERNAL)
    ...
    if(ALLOW_EXTERNAL_PROJECTS AND NOT ${FIND_PACKAGE_EXTERNAL_PACKAGE_UPPERCASE}_FOUND)
        ...
        set(${FIND_PACKAGE_EXTERNAL_PACKAGE_UPPERCASE}_EXTERNAL True)
    endif()
endfunction()
...
function(ADD_DEPENDENCY_EXTERNAL)
    ...
    string(TOUPPER ${ADD_DEPENDENCY_EXTERNAL_PACKAGE} ADD_DEPENDENCY_EXTERNAL_PACKAGE)
    if(ALLOW_EXTERNAL_PROJECTS AND ${ADD_DEPENDENCY_EXTERNAL_PACKAGE}_EXTERNAL)
        add_dependencies(${ADD_DEPENDECY_EXTERNAL_TARGET} ${ADD_DEPENDENCY_EXTERNAL_PACKAGE})
    endif()
endfunction()
