...
\item[{{\bf openmode}}]{mode = {\ttfamily {\bf openmode\-::read\-\_\-write}~$\vert$~{\bf openmode\-::create}}, }
...
Definition at line 239 of file D\-B\-Connection.\-h.
...
\begin{DoxyParams}[1]{Parameters}
\mbox{\tt in}  & {\em filename} & path to S\-Q\-Lite file \\
\hline
